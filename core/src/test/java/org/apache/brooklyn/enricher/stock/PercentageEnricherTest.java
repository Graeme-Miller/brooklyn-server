...
public class PercentageEnricherTest extends BrooklynAppUnitTestSupport {
    ...
    public void vanillaTest() {
        ...
        assertEquals(app.sensors().get(targetSensor), 50d);
    }
    ...
    public void currentNullTest() {
        ...
        app.sensors().set(totalSensor, 100d);
        assertEquals(app.sensors().get(targetSensor), null);
    }
    ...
    public void currentZeroTest() {
        ...
        app.sensors().set(totalSensor, 100d);
        assertEquals(app.sensors().get(targetSensor), 0d);
    }
    ...
    public void oneHundredPercentTest() {
        ...
        assertEquals(app.sensors().get(targetSensor), 100d);
    }
    ...
    public void testDifferentProducer() {
        ...
        assertEquals(app.sensors().get(targetSensor), 50d);
        assertEquals(producer.sensors().get(targetSensor), null);
    }
